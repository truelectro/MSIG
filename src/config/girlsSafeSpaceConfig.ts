...
export const gssCampusStops: GssCampusStop[] = [
  {
    ...
    dateDisplay: "Friday, October 23, 2026",
  ...
  },
  {
    ...
    shortName: "KNUST",
    city: "Kumasi",
    venue: "Great Hall Terraces & Sunken Garden Lounge",
    dateDisplay: "Wednesday, October 28, 2026",
    timeDisplay: "10:00 AM – 5:00 PM",
    spotsLeft: 28,
    status: "few_left",
    isFlagship: true,
  },
  {
    ...
    shortName: "UPSA",
    city: "Madina, Accra",
    venue: "Student Centre Hub & Atrium",
  ...
  },
  {
    ...
    shortName: "UCC",
    city: "Cape Coast",
    venue: "Casely Hayford Oceanview Courtyard",
    dateDisplay: "Friday, November 13, 2026",
    timeDisplay: "10:00 AM – 4:30 PM",
    spotsLeft: 60,
    status: "open",
  },
  {
    ...
    shortName: "TTU",
    city: "Takoradi",
    venue: "Main Campus Amphitheatre Green",
    dateDisplay: "Tuesday, November 17, 2026",
    timeDisplay: "10:30 AM – 4:30 PM",
    spotsLeft: 35,
    status: "open",
  },
  {
    ...
    shortName: "UDS",
    city: "Tamale",
    venue: "Central Auditorium Garden Pavilion",
    dateDisplay: "Friday, November 27, 2026",
    timeDisplay: "9:30 AM – 3:30 PM",
    spotsLeft: 50,
    status: "open",
  },
  {
    id: "accra-urban-pro",
    institution: "Urban Working Women Edition",
    shortName: "Accra Young Pros",
    city: "Airport City & Osu, Accra",
    venue: "The Greenhouse Creative Studio, Osu",
