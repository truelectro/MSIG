...
export const metadata: Metadata = {
  ...
  description:
    "Official attendee roster and coordinator dashboard for Girls' Safe Space at UPSA. Track registrations, BK-1 emergency kits, and clinical breast screenings.",
};
